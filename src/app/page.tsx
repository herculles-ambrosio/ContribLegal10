...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      >
        <h2 className="text-3xl font-bold text-center mb-12 text-[#1A1A1A] relative pb-4 after:content-[''] after:absolute after:left-1/2 after:-ml-12 after:bottom-0 after:w-24 after:h-1 after:bg-blue-600 after:rounded-full">Como Funciona</h2>
      ...
      >
        <h2 className="text-3xl font-bold text-center mb-12 text-[#1A1A1A] relative pb-4 after:content-[''] after:absolute after:left-1/2 after:-ml-12 after:bottom-0 after:w-24 after:h-1 after:bg-blue-600 after:rounded-full">Benefícios</h2>
      ...
      >
        <h2 className="text-3xl font-bold mb-6 text-white">Pronto para participar?</h2>
